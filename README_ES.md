...
> ⏰ Última actualización: 2026-06-20 14:07 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-uWySFWtPxViQjhnr12SaEY94JTO1lEUuVLJqwM5aDroucczQ` | kimi-k2.5 | 🆕 Nueva | $13 | 10 RPM | 2026-06-21 | Kimi long-context general model |
