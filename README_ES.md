...
> ⏰ Última actualización: 2026-06-22 23:22 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-22 23:22`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-QMkokQfDmrbddi3yyWMQ1D6xR6wNxbqYVUvqsott83QwxK0e` | smart-chat | 🆕 Nueva | $0 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |
...
| `sk-H1SaetWIMgNRceJdvEwSm78np50avnx0r7jtUAVSU3KwLfeN` | kimi-k2.5 | 🆕 Nueva | $9 | 10 RPM | 2026-06-24 | Kimi long-context general model |
