...
> ⏰ Última actualización: 2026-06-19 21:37 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-CLCt0BwF8xveh56TbxVVG10v6lFE9Ozvemm6rSoZg9lqc5DF` | kimi-k2.5 | 🆕 Nueva | $9 | 10 RPM | 2026-06-21 | Kimi long-context general model |
