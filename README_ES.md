...
> ⏰ Última actualización: 2026-06-19 17:37 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-AqfidMUCsP4SLgNkFYcltPNN7FiqJ9QvOxIVQGQcZ05Msgsr` | kimi-k2.5 | 🆕 Nueva | $9 | 10 RPM | 2026-06-21 | Kimi long-context general model |
