...
[![Keys](https://img.shields.io/badge/Claves_Disponibles-54-brightgreen?style=for-the-badge)]()
...
> ⏰ Última actualización: 2026-06-26 04:30 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-FIC8yZ9bfBdWoTspA3d1NE6ufqoGtnDLQhO0rro0bSiFbD4Y` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Fast Gemini option for long-context general chat |
| `sk-k3nOZqm35D0F39cToIGhCyuucFlQyAfSwENWnnHAt8azr9OS` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Fast Gemini option for long-context general chat |
| `sk-tZECaEGfWsZ42jZ0fkn7VVQW0SapYSPRr3PPAjxYiuGtrnpd` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Fast Gemini option for long-context general chat |
| `sk-UXVKv1VaoyWqKMdKn4l9DkHxS5kyUvSLTYs8Aw4hXDcRGrMG` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Fast Gemini option for long-context general chat |
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-ACwBh7robPk5NWQrLNPOAq33rumaojj3Od1KBgku9nEnrgVC` | deepseek-chat | 🆕 Nueva | $16 | 20 RPM | 2026-06-27 | Everyday chat, coding, translation, writing |
| `sk-WeYgqA93Wl5tJT4QKZUVb14ee7eCpac3I3e25H8yoJYOqiHu` | deepseek-chat | 🆕 Nueva | $11 | 20 RPM | 2026-06-26 | Everyday chat, coding, translation, writing |
| `sk-boe4SxYtfoBKL9NlRfPJwI3o5KTvt4EmdXKxnmEmxZZIKbew` | deepseek-chat | 🆕 Nueva | $12 | 20 RPM | 2026-06-26 | Everyday chat, coding, translation, writing |

### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-26 04:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-pvoxTjsCSKZtHrKSXq7O0AXgz2L0vTi9Nl3IbmwHXRlTATyv` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-vhkNXLBc1XL8mpDWV0TcCkNJPudsWGgP84rnzlDGKhruL2wA` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-VNevwZdKr5YK4vDbo79cIhY5B4ZqKdWrHQMKWvQBzipDQaSv` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Hf4K6IuQQTC7WoGpk2mvbf1cckb6mBjVAhrBXdT3S2lWZ54M` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-hboQYYv9ABN0sHMUNVmVPIjTk2sE0joJDZu8tNnJc8zR2yth` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-zObRXK4vJKEFmrIYkl1O3rako4iWUxRUyiDzBa8eHPptdaUM` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-26 04:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-dlZl6ZCfx7dPNrPRQPyyAvTbd0o3CpwSg54REKAzP9V70vrm` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-hCSVKSpUmx0mH3HKyfi7zvdI0Gx1SDpnd6QT36oQJM1zSDyt` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-KXjHMd5yFJyarQ7nN7jO0Lvq3cHVPm1mdZDELsNsjNs8lvlw` | kimi-k2.5 | 🆕 Nueva | $15 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-1HgwKhuIJucDhxUWFiPukU7l8exYZBIRAM7eA6QqM9Q4FU77` | kimi-k2.5 | 🆕 Nueva | $13 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-DKh3YZijb2WfoO8bFeaFPZZMRfeMEsOwFO1ssUNjqPvK5TaD` | kimi-k2.5 | 🆕 Nueva | $10 | 10 RPM | 2026-06-27 | Kimi long-context general model |

### Image / Audio / Embedding `06-26 04:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-ZcNHy86ZlQnr3MCXwkHEsHwfPrjYlcLJePySk3zNS4rHUH9j` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Text embeddings |
| `sk-vae9NLsxl9m8BbIFDIGreZOvmDmOnp9Of9bmXHa6cnW1cgDJ` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Text embeddings |
| `sk-WMmBH48QVHMYjZSMYFoYeWFGuC0yao0CjrlsBKZjOPwV8SZY` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-27 | Text embeddings |
