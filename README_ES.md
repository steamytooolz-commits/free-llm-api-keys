...
> ⏰ Última actualización: 2026-06-21 04:37 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-mJSFxWRVpfOG1I84FzRREfvtKgbRhwDFF6n7RQFiwWaygJBw` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-22 | Claude Opus flagship |
| `sk-T3jAVh6RcgmxVmgqiMYARItNTAN4qhiU7FOBzxRTE8gxUZDv` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-22 | Claude Opus flagship |
| `sk-Z7HhRX7ERN472YYGYS4C5AnvZvO3BxDwBMlyLEwgHsMxtyN4` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-22 | Claude Opus flagship |
| `sk-e4bhTVNU7BXJSrtKPCWEkWebg7WjCTHGb5f3hbgZryQw07B5` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-22 | Claude Opus flagship |
| `sk-64PsU7L5PBA8kqou2GbISWpLN8AG8yRiRw34zb7LxOFFN3a2` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-22 | Claude Opus flagship |
| `sk-qX39R0dgToVLF4ZfiRE2TJzygHZZvsPTtU00cWUjbB11zYLP` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-22 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-21 04:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-Adss3XxELkGq8u76fSifYScMCzgopeQS9JunnZo7GedbPmmR` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |
| `sk-oD42k6ZgOtq3YriLaAtWqJAml8h9Lw7nt9zNy9dzYSq6UDwA` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |
| `sk-wgscSRozq6RjTix08f3nzDvF9hjwKgivZsxJc8kEqKnTX5AA` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |
| `sk-LVyikto0G7qGJ1cxVMvAADwHt8Setcnfa6K1eTs0urWTxM0z` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |
| `sk-YbDUgmu4JVzKftZd3pZlQvzZAC9Y3HlqABZSkmo93LLCJHmR` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |
| `sk-YYiZHVBd6mPBqsiajHYjmWLDeXfRPWkE5ZYX7e77yfjuaKjL` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-21 04:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-UBMqzzMURPt5Xb3OW6XoiUwVhQ9UTnBvz2h97Enqvl7C402O` | kimi-k2.5 | 🆕 Nueva | $16 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-qwm8L58tWpPJEu0j8AMGK5SW6q38D51kX8yY8SBqoduv23RL` | kimi-k2.5 | 🆕 Nueva | $17 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-46ZLrIQOHjs8sVQGaqecjv80xzhYioxrdUiqqinwIRg5lhAY` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-22 | Kimi long-context general model |
