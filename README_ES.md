...
> ⏰ Última actualización: 2026-06-14 20:30 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-YMiH9cKY3PepELs8ZL5mbNVq5UNUhJegTs10iCVOc85RDnNw` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Fast Gemini option for long-context general chat |
| `sk-YsZ4W1nK28kyJyBm7aHPrV5wFns1f9ybsmag55gvAv7PUC1x` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Fast Gemini option for long-context general chat |
| `sk-HUtjXlHh8rucHCgrigxEpmsIi1dS5IcSKQrVNvjMTa43rFt9` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Fast Gemini option for long-context general chat |
| `sk-mZWtTTJqQAzMncouW8rQ2QsWDbAKg93DY6UQRnInBMri2RLO` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Fast Gemini option for long-context general chat |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-14 20:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-WsDZ9OL9RkeMgDxeub8ZNUzhCttX9h0OkDWMkjABQnukUuPh` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-FKHtptwnTOe5rgFxRnY2t3NTjMQ94QhUSg8ABuEPAzSMbznV` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-BstaAmvIwdTrlg9f4s3MgB9n9isOpHhPzY09RnZTE4SUDDKv` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-YH5PyrB1c9GwnVdaMAHooXITP1KaMCP99HjgvFroQvWjat0C` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Di3xKpx3zUZflnNY3JJdhNzM0GRtmBl603sTEeQ691P9YXRJ` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-DgrfxnngRiwvt6IbBJpjrq8czLKRfLXEzSxyNx0KQ0srjjqV` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-14 20:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-PQ1hKF7aw6HWvze8Miuc3G8N2j6Yl19bxdNy4kk1uZVPahDY` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Kimi long-context general model |
| `sk-uSNREYWEhTk0rl1TP6fG1WpPHTl7Ai5wXIH7EZh02aPsWixA` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-16 | Kimi long-context general model |
| `sk-DKkEhS4SC4xvuWz2rh26IaOQISzgU0i4kcOZL7OKDEdsoCGc` | kimi-k2.5 | 🆕 Nueva | $13 | 10 RPM | 2026-06-16 | Kimi long-context general model |
| `sk-iEB2dUsMopECTKbC5IW2x751jixo8xPrdfaznMcpmuJRpBFa` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-16 | Kimi long-context general model |

### Image / Audio / Embedding `06-14 20:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-UJ7D0v6jp0XxHt9AdclLC2riGhhhb2SiNVMWydyR7nlkYUgE` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Text embeddings |
| `sk-XWhJ1WEtUALeIExBTPzOhDcEYDgfusF4g88hQfVdi5hD3lqU` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Text embeddings |
| `sk-V9O4mI6WvMbpGphji0yRHelAhCmD3apzLdbys4ECxJMDPwRp` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-14 | Text embeddings |
