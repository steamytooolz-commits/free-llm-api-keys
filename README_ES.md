...
> ⏰ Última actualización: 2026-06-16 04:37 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-uhatHVsCGeYUtOS6KXj2YVptyBWX87SvvcPuUw6nk8Xe982p` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-16 | Claude Opus flagship |
| `sk-JkiiprXLy3WmebpzkU3lqeXqiwQi34Ma0lbJICvyzIZQvmvx` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-16 | Claude Opus flagship |
| `sk-LDphiR7aRY48qFFb17WrihVli0kdC7CVa38ALt0BB0W48Swf` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-16 | Claude Opus flagship |
| `sk-g3EjiJfOZIlNlnkxaUNohUrUBZAjNuK1KtwM4CUmfrYdjNIa` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-16 | Claude Opus flagship |
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-CS4zrotEUJfLS79kAD8yRG6fh9diKnbA8gdAvc92pKJ4Hxlj` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Fast Gemini option for long-context general chat |
| `sk-vpT4LhSjkJHnlqiNUykQSw2OnWE54uPgZTvUH2IVNuXsEFjA` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Fast Gemini option for long-context general chat |
| `sk-BprJAZV5qlXKl1cPuimk7zh0PFEsFXI1yt2UcToBTkpJTmAc` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Fast Gemini option for long-context general chat |
| `sk-CytwCeM6tmAyAoPjku5Tuovck3JEM7U5dPnv3CSzCczlPGHF` | gemini-2.5-flash | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Fast Gemini option for long-context general chat |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-16 04:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-oSpd0M9fQZ37WurG7XpQnF0ygVLOe1CqDqHm7aRkZa0FfF2c` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |
| `sk-OTEzUHMbUzkzzz7ClLSZGx99rBnVEJIKR11O9659vDfOquyZ` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Xwju9dIQxzPkDbYFVmzUoVdJHqR9EJPvGeoAGnN9rWe1EHFt` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Xj1YgpCuXhEnc9jE397MOe5T268IQvif4z8fFWjr9mm0mK8h` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |
| `sk-UIL4MSXRdYL0BJ1BM94lI1h8bapGa7WSKniZe6AoP8F0AdOI` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |
| `sk-a4hSQS4IK6Hej5a8Pe8jLqNKVqRONljhn0eZxTkeQcObntFw` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-16 04:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-S0fnt1ku7BpLJHsH6Xm1lz9iGKPwfFZGBMkOBf79F4rjTnzA` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-DkKxR5l8VBA0YjMLP1JThxHC3gLFxvCt1qzyL5pQc2AvpzkE` | kimi-k2.5 | 🆕 Nueva | $17 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-xi4YTVeaqdBeQ4bKRhRqU2HI5bgoZBj4dSG9GxMzV0vIzVqW` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-MNtLvKp3lb2xidFLkHrHY99JZNcSIBheGrfUN9fCDw0YDjbh` | kimi-k2.5 | 🆕 Nueva | $17 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-q9SFR1JuCPdRfejoaiDVItaqJH7LHRkdx2788GDGV4K29feP` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-17 | Kimi long-context general model |

### Image / Audio / Embedding `06-16 04:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-OJDNZeiBPKvdqZxIa29q20YsFYpUx1yUYNe2HMPxz87mdOJe` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Text embeddings |
| `sk-oLJIiPS8ZoWoAoEMYUQ1nEDDuMT2gq6DI8y6CZhjG501qkYU` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Text embeddings |
| `sk-ZmZkSjnWcczHpf4bhVmznqSnEd8g8zgvAkTIIg0nWOuCjKMS` | text-embedding-3-small | 🆕 Nueva | $20 | 20 RPM | 2026-06-16 | Text embeddings |
