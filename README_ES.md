...
> ⏰ Última actualización: 2026-06-20 02:30 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-jxp5MEfS53G3N2XsFyEumjRvU1PFQYEFb3EP53iWX9D9N4ur` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-L2sLoX5EA4pa4eYeIlJiKG9GwLfJU0KxWlVdpmHXeYX09HxH` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-hOZjBGFTDVfb2KjjEenQlq3XUMHxKipClZBWmrvq2PqtnJlY` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-XpqYdpWx7122lE3ijRnuxzyGhdyZuYA4fHVhPZh0GkiBLLbP` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-e7pHSE4iXx15Nyq01c3ZX39UAgb9Bc2arVuAGCF9AfOojgZA` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-dj54P0lPmMUjE0I6KqAlPWUPEyWRYqo9ZYH5btB56JRZiGBl` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-20 02:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-1CZKpZ7wTCM3sBP6IIP2oDGo6G2NecspBFBBR9Gk6dsBGmwo` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Gc3lVSHRj9J86e4j2izxnc6oJO0izNW6uPHEVNp5U3yzGP1U` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-YYMmn37gZySnTs1YXQWwTqoGJnbeYsVcFU51bKGFGy702jY3` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-5WaHBhjOqyp71rom0QtFp7ThBTsdBoQWr2DEEF3TEGd9Y6Mc` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-0yjT0TlnI2IsnTrVMlthqGgniOyT0cDBiKsdVHxPpyxuFjUj` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-jl0sTmMUjHqVKfH4ruBCwmG42Bve2cWeUmYwrIGZDHJpN3Ib` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-20 02:30`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-wnStdUaI7UqGcwR083aS2thE2yeasYtPJmK7rEqzknTLwHfB` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-BW3P0qNrTKLdc75CMUpM3P0V68DSFwpwIwnIi3XtMcCBncHn` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-C12pRFZu75cs44cxWc98YbN0cvYaNZR1cjgu8eSEYVwn7B1h` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-Pt9xcgNrtUgO01L872w9bDgO6qlfhyoJHmQiVTmBTw7RSaGL` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-Tsebc9CVQ2VkBFkRzKN2H9bQsU66awyJmb8m5DMcLyOyTdgB` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-07MUGPTIgbdN3IwoexdJVhKbl4vDmkE0iX5PYFxcf48PZe06` | kimi-k2.5 | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Kimi long-context general model |
