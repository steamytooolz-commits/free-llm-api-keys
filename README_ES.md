...
> ⏰ Última actualización: 2026-06-24 10:22 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-24 10:22`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-nm6NX28HrZRjEovS7TEAqYzyxqocuCA6bDMuBBy6XKhWLsu0` | smart-chat | 🆕 Nueva | $10 | 10 RPM | 2026-06-26 | Auto-routes across currently healthy low-cost chat backends |
