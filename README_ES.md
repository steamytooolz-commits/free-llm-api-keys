...
> ⏰ Última actualización: 2026-06-20 08:07 (UTC+8)
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-Tsebc9CVQ2VkBFkRzKN2H9bQsU66awyJmb8m5DMcLyOyTdgB` | kimi-k2.5 | 🆕 Nueva | $7 | 10 RPM | 2026-06-21 | Kimi long-context general model |
