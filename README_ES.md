...
> ⏰ Última actualización: 2026-06-22 21:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-22 21:37`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-fv3HdmmlhgCu6fSq2Z38VrgP3boNJMaqY7HsZ9TNXxN9NUpw` | smart-chat | 🆕 Nueva | $11 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |
