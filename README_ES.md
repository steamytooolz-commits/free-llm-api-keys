...
> ⏰ Última actualización: 2026-06-19 05:22 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-GzdBRSjLa7tCa27N02s5gHOdYaxLEbbdQHHe0OhIssaXDPVX` | claude-opus-4-7 | 🆕 Nueva | $5 | 5 RPM | 2026-06-20 | Claude Opus flagship |
...
| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-BqEoe4lOH9i8rfOrwC4YCZ6R4wCH5GsWCoaChfVKrR496meC` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-20 | Kimi long-context general model |
