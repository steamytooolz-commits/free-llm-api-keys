...
> ⏰ Última actualización: 2026-06-19 16:52 (UTC+8)
...
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-h69HDhGNJT7UwRMKcZuW2hrQHBsxu9xRUSeCsAObQod70BwY` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-95c9FCoMMPjQftabXxZgydrIkqmzHlurqqxrKy5aQDqUpCHw` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-ljQHiKY1NDPvRDgrAP4m18JYOl6lxy5JDTXcQhViSvsFBtXZ` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-aI58KaXnquEAKIsYu0AYIBOSp1NPjkBTMOUN6ovyVpawHwFJ` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
| `sk-8ATJbL1vXde2maHCq5QLhPqFOVofRHDnMEKTeC3FITDH0EVc` | claude-opus-4-7 | 🆕 Nueva | $20 | 5 RPM | 2026-06-21 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini ruteo automático) `06-19 16:52`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-jF5V8LAK1jSXiHxxXfNi6RGFHcWoNryDnfveffOvulmIC8d5` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-D1ilz9wKaJLHhJql0yJHfREyx5EPVcKihhUcEFIwbtQOJq2u` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-X986aAAemnqWqxZOnACdQiyTwvPIYKzar9cegYKw2y9VRKCE` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-VmOJ4I0Ua608PzHOd5uJ9NlBiyqtH1Uh1Llb2OS0R7WE2hcu` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-AKdOe7HufMdLQwZH1dvPd7WXC0HWYjvcxf7AvG28vinE83AD` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |
| `sk-2zBfxVCyTWd9LiowmdjHIrZoZNXMgVXrhKSwrXcyOt45xfEB` | smart-chat | 🆕 Nueva | $20 | 10 RPM | 2026-06-21 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-19 16:52`

| Key | Modelo | Estado | Presupuesto | Tasa | Expira | Descripción |
|-----|--------|--------|-------------|------|--------|-------------|
| `sk-g3v8QxCMFNdLGtfPD0j0k0aKS2YqCaBLopqZUShaCXDCItnp` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-P93tvPqiDPjFOnnKqIg7VcIbUgysRx2dDHOXwwDfTOIis0ja` | kimi-k2.5 | 🆕 Nueva | $19 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-qV4wT73VmxN7n5YmTp0nCwnjJtX8oKujOyQQBCim2u5l3995` | kimi-k2.5 | 🆕 Nueva | $9 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-Alj2kv5W7YxTTwMMmwR4nRDYqTuMPJwGW7myX5glwbxfzHga` | kimi-k2.5 | 🆕 Nueva | $13 | 10 RPM | 2026-06-21 | Kimi long-context general model |
| `sk-mOuMiOqpzloCfZSI4td3IkXjaAykNCWfJZPZL5qhnZgU6ONG` | kimi-k2.5 | 🆕 Nueva | $9 | 10 RPM | 2026-06-21 | Kimi long-context general model |
