...
### DeepSeek `05-06 04:22`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-5HdDpDhhiEw7uyobkLNmyvGOvf4QFaP6JqjdMx7RFigoOXgi` | deepseek-chat | 🆕 新增 | $10 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |
| `sk-plMBUkF55ZDNc2wbG0FeiWIcy9sUH2MHO43kSbfNX4egqOCf` | deepseek-chat | 🆕 新增 | $13 | 20 RPM | 2026-05-07 | 日常对话、代码生成、翻译写作 |

---

### 多模型聚合（GPT-5.5 / Claude / DeepSeek / Gemini 自动轮询） `05-06 04:22`

| Key | 模型 | 状态 | 预算 | 速率限制 | 过期时间 | 说明 |
|-----|------|------|------|---------|---------|------|
| `sk-dl577atjFuICp2BYThk1WA9fr90MdOz3rw4VosMcQcL40vlD` | smart-chat | 🆕 新增 | $8 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-QoMdpFLs64MvXTBnbQx0aL7gocnjjo5ruau1Wmh1S04sGHMY` | smart-chat | 🆕 新增 | $10 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
| `sk-DjSNpKT0ZK0rUkRMgluJThuX8mQldepGKMJOiwsr6JtIbAb0` | smart-chat | 🆕 新增 | $20 | 10 RPM | 2026-05-07 | 自动路由到当前健康的低成本聊天模型 |
