...
> ⏰ 마지막 업데이트: 2026-06-24 10:07 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-24 10:07`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-w9BpMOyf97rsy7z2pka9cho3Kfbewsx9kqkt13UCDtnJ1MbV` | smart-chat | 🆕 신규 | $17 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |
