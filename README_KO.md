...
> ⏰ 마지막 업데이트: 2026-06-16 04:52 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-16 04:52`
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-SOuSV28QPszBSV4XYAPMc0M22IRI4fY2fVckyHMFmhYx445K` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-17 | Kimi long-context general model |
