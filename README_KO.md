...
> ⏰ 마지막 업데이트: 2026-06-19 05:22 (UTC+8)
...
|-----|------|------|------|------|------|------|
| `sk-GzdBRSjLa7tCa27N02s5gHOdYaxLEbbdQHHe0OhIssaXDPVX` | claude-opus-4-7 | 🆕 신규 | $5 | 5 RPM | 2026-06-20 | Claude Opus flagship |
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-BqEoe4lOH9i8rfOrwC4YCZ6R4wCH5GsWCoaChfVKrR496meC` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-20 | Kimi long-context general model |
