...
> ⏰ 마지막 업데이트: 2026-06-23 06:52 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-23 06:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-eskDVZGO29Shwi70GA3QIT7TRFHuifI9w7BGXxp9sQGqX7hQ` | smart-chat | 🆕 신규 | $19 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-23 06:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-69IIPi19QC2Wz73Mrmt6Xeup1lMhoBU0VhBnttAs2HzNUtWj` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-24 | Kimi long-context general model |
| `sk-Xv3LfuGoAzAo15RAdpINc7CKUOvq1vsZNVEMUvQVe8jK8Wrw` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-24 | Kimi long-context general model |
| `sk-bRDyJaW6vnfADgzeBf09ggdOJDx0GqjRoiS1ZEDyX1aVakih` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-24 | Kimi long-context general model |
| `sk-rrlfiMp4Gjm9r6fEYHT0UjhBlr8u3cFPQ4rOeNhaBQ74wUAJ` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-24 | Kimi long-context general model |
