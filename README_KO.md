...
[![Keys](https://img.shields.io/badge/사용_가능_Key-5-brightgreen?style=for-the-badge)]()
...
> ⏰ 마지막 업데이트: 2026-05-23 20:48 (UTC+8)
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-y9Y6dHDM1PeVRPcxXSSksssvyr5rGRBsuhpUK8CELZuo3DOI` | deepseek-chat | 🆕 신규 | $19 | 20 RPM | 2026-05-25 | Everyday chat, coding, translation, writing |

### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `05-23 20:48`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-92cU7NiE9OUEHZvyZIRsodRMFCMVjgDRPvyeIjLWwP5I64ds` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-05-25 | Auto-routes across currently healthy low-cost chat backends |
