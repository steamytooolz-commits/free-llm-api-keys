...
> ⏰ 마지막 업데이트: 2026-05-26 16:37 (UTC+8)
...
|-----|------|------|------|------|------|------|
| `sk-4Cz1tOnEjcLsuAjWxOefbdDkKYOD6zV3vwYm00JBop4E2xda` | gpt-5.5 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Premium GPT flagship |

### Claude Opus 4.7 `05-26 16:37`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-WkiaUbs0qjKzD1azrmbIwhVT3iV0O8O2nTFwQXa8GNpW75Sk` | claude-opus-4-7 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Claude Opus flagship |
| `sk-Ewqs1IqTgCbgEFi0K1pqA853FlQS8RpB5kI0aCP8SBP9e0lS` | claude-opus-4-7 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Claude Opus flagship |
| `sk-FGJC2NiYYig1zygDlHqNmcq6rZqC2erwiIgH8HolScLeiEjN` | claude-opus-4-7 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Claude Opus flagship |
| `sk-DQjqlS6zaHWpz5uea555n2VTEcgw46ZCACxCKmbLaYaMfF0q` | claude-opus-4-7 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Claude Opus flagship |
| `sk-e3sGIR0hPKKkhnBMpnrMzdyfyKOV6K3gPrQnb7GmU4Uyu9vL` | claude-opus-4-7 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Claude Opus flagship |
| `sk-sDZZduGhuzlmZ6e667FLAXu4zuy3UQTeDxTkKRrQrTCYoijC` | claude-opus-4-7 | 🆕 신규 | $20 | 5 RPM | 2026-05-28 | Claude Opus flagship |
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-DpwzSAfPlKX8F1tTJxUHlzH5SvwvBEI1ClqwvnLpWqcdQbk1` | deepseek-chat | 🆕 신규 | $17 | 20 RPM | 2026-05-28 | Everyday chat, coding, translation, writing |

### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `05-26 16:37`
