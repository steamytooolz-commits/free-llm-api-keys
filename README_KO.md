...
> ⏰ 마지막 업데이트: 2026-06-24 00:52 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-24 00:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-KuxSJ5SF7ldJjylP26djt9fCukdsgc2PGPu5JkaOlV0769bM` | smart-chat | 🆕 신규 | $19 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-24 00:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-kg0eE7ahqDdQqRQoqZLO0jByknAFVWlWwocIcl9zEXPXL3tK` | kimi-k2.5 | 🆕 신규 | $10 | 10 RPM | 2026-06-25 | Kimi long-context general model |
