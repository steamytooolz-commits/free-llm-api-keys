...
> ⏰ 마지막 업데이트: 2026-06-20 19:07 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-20 19:07`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-SPXvwM6X66f1MjxZtvdPiHLnSoOcjzAwYgw1tR4RPS2AYwi2` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-22 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-20 19:07`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-xbgp3ls941ePMGujLGx87fmbnEjqlajxyK756deRzeWwM8vy` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-wxMWIcgr8bo9zBmuJhryhQqqVCqA7bZMnQFrEdsONkJPa608` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-bXPaE593HpCWMstVoTJzorLjEbmZJxi2OWvLMemi6ZVjc8I0` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-IklijDWGU67A72Kb0Wa4fESr3M40h11bc461fPdpRFyIJ99j` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-tmM1eNGWDpyxYIauihtPXSlBQuI6UqHObvlFxnTiLaoumtBi` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-22 | Kimi long-context general model |
| `sk-3zuHG5oXfRPvrWZK9wlWwWCSVdJohW7181ZruVHZalxwYnlJ` | kimi-k2.5 | 🆕 신규 | $15 | 10 RPM | 2026-06-22 | Kimi long-context general model |
