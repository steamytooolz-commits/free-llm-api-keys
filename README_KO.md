...
> ⏰ 마지막 업데이트: 2026-06-24 04:07 (UTC+8)
...
| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-WiyX4lkDLxtNeelOTBAxFtkPfZiRyJd6lDVoOlbikx6esye4` | deepseek-chat | 🆕 신규 | $15 | 20 RPM | 2026-06-25 | Everyday chat, coding, translation, writing |

### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-24 04:07`
