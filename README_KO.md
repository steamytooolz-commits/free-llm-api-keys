...
> ⏰ 마지막 업데이트: 2026-06-16 02:52 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-16 02:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-2lidsy2tVPonz3EjzBhz89SHcEBJApA8fwp0RCzhpd8RAl8i` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Z9R6y7bOWntkDWHNd4pbPgVZWbXDzqgbYfXW0oJ48Nh0lbrD` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-17 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-16 02:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-q9SFR1JuCPdRfejoaiDVItaqJH7LHRkdx2788GDGV4K29feP` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-MNtLvKp3lb2xidFLkHrHY99JZNcSIBheGrfUN9fCDw0YDjbh` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-xi4YTVeaqdBeQ4bKRhRqU2HI5bgoZBj4dSG9GxMzV0vIzVqW` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-17 | Kimi long-context general model |
| `sk-2K8o2RSWGKFMXbEcvAYhfWBDazh47PBKyz6LNlDVuuDFCpQX` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-17 | Kimi long-context general model |
