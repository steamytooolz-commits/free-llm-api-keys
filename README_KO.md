...
> ⏰ 마지막 업데이트: 2026-06-24 05:37 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-24 05:37`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-2WuKcCv47Ay2Tk5DDEbNoD5RHeADnQR97fne8MyfSBrH8v91` | smart-chat | 🆕 신규 | $13 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-24 05:37`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-lRpmjgxVSbx8P2Q9fxlMaHMd73DZBGZ1ZbSPfY9gjZmpV7tq` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-25 | Kimi long-context general model |
