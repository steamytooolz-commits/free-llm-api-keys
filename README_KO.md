...
> ⏰ 마지막 업데이트: 2026-06-17 00:52 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-17 00:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-B7soYzUFZXyK8Apx3f7n2nKP1b8sK0sQSusW7qcKZau5sNGl` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Auto-routes across currently healthy low-cost chat backends |
| `sk-s6jBCm8UKATvDNvOLSExFwOwb2L3cogztuXLn8T4ajKlPCIb` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-17 00:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-IS3Sa50tlcwnOQp1BAJI8yVgCwDg085knGV61Slm38OLtxke` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Kimi long-context general model |
| `sk-rDGUPsze1VMqcz7XP2UqUxrOjfqRLlmTOKcORqtboXr8IKsT` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Kimi long-context general model |
| `sk-esGqzsH0pAHTuXSLqIec6gsPo9rF4Q9varLYHBm6HowfFHlQ` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Kimi long-context general model |
| `sk-G0Imv2dGtIJBAsN4zaawGhzzXu3JEtLE2xuXh6c52GjrwEC0` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Kimi long-context general model |
| `sk-wCsRmdxdoRp6C8gFwgb0mAOc6JqM2BA789FO2xUC5lF69NAn` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Kimi long-context general model |
| `sk-0TQkcXVNFaslZK0aLznDjKPxNfSXAsiGyXnQ9i2bxWH4UBFo` | kimi-k2.5 | 🆕 신규 | $20 | 10 RPM | 2026-06-18 | Kimi long-context general model |
