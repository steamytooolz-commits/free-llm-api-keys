...
> ⏰ 마지막 업데이트: 2026-06-23 16:22 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-23 16:22`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-KLeXLGdmuTYN8Qk9Lx3RxOQ0OoLnk9VGLudyD0LVpqgJVLzQ` | smart-chat | 🆕 신규 | $15 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |
