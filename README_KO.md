...
> ⏰ 마지막 업데이트: 2026-06-24 10:22 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-24 10:22`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-nm6NX28HrZRjEovS7TEAqYzyxqocuCA6bDMuBBy6XKhWLsu0` | smart-chat | 🆕 신규 | $10 | 10 RPM | 2026-06-26 | Auto-routes across currently healthy low-cost chat backends |
