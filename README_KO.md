...
> ⏰ 마지막 업데이트: 2026-06-14 22:52 (UTC+8)
...
### 멀티 모델 (GPT-5.5 / Claude / DeepSeek / Gemini 자동 라우팅) `06-14 22:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-AKTM83ipUVIkb0I09plHS9vtoM79Ir091TSOqytqPIz0NNzU` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-g6yMlCWofp0LS9PgRJ97irEISuJLuvi6dxCOkzBXgy1T8zwE` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-AYMl9ulZEhBZWhGzeDhB2hIpHfwzTOCCZOw7M3XWet1SSvr5` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-gyQVJJORqtI9CyD41tDqh1RI716ThZH1bfYC8lha70e1B7bI` | smart-chat | 🆕 신규 | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-14 22:52`

| Key | 모델 | 상태 | 예산 | 속도 | 만료 | 설명 |
|-----|------|------|------|------|------|------|
| `sk-3EiirowRPaIRCNJhmSA5oBefWic3wcSqTVUIv5qD7EKDLmff` | kimi-k2.5 | 🆕 신규 | $19 | 10 RPM | 2026-06-16 | Kimi long-context general model |
