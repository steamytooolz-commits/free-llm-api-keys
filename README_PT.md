...
> ⏰ Última atualização: 2026-06-04 15:07 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-fm03zlP7SyXmgi4yoijlJSsU8Hep5k9iw7enF0bN3ArUSR2S` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-06 | Claude Opus flagship |
| `sk-uMapJwXQ1mjkZJNqx29LYULwDs2PylzTugNwp75xWtB1qR8Z` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-06 | Claude Opus flagship |
| `sk-xJSOr3BB9atSpBiJgRv4oE1jBnmQPJvWAvkweGCUGllFveXD` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-06 | Claude Opus flagship |
| `sk-EbKd07KQi7TvrCxEEnGQYwmAHMWCIEbIzMZaVsZtrq9AyZpZ` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-06 | Claude Opus flagship |
| `sk-4M6FtEykJjTVAsrv0Joam9ApWMpGcqWuWaPl03IYj7GDrf57` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-06 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-04 15:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-rnWW7W4H1l6fpSOAxyIYqGPquln0xO9NiVsYmOTW8aXXHKMu` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-06 | Auto-routes across currently healthy low-cost chat backends |
| `sk-j2BHFYy2OpUc830pmbvSQaZo9axWwdcVtxhX4jAyrWT3Ob8Z` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-06 | Auto-routes across currently healthy low-cost chat backends |
| `sk-tsyR5DiwUWB4SfFxHu60ym2nkRlscyegXF9rt2LkCL9JMVx6` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-06 | Auto-routes across currently healthy low-cost chat backends |
| `sk-IBk5nriIW5D2NVUTF2kk8eBIgXzlJcwaPubeXSfhbXzolM9r` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-06 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-04 15:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-oLpfQHkdgKWFg2pFvXJBsPh6bbpfe7pX3d8qRRe8etQYvorm` | kimi-k2.5 | 🆕 Nova | $17 | 10 RPM | 2026-06-06 | Kimi long-context general model |
| `sk-YVuumFhMYGlyHUFvsDkog2watGQBwqSRGMDAaHFBrTgqmj8E` | kimi-k2.5 | 🆕 Nova | $17 | 10 RPM | 2026-06-06 | Kimi long-context general model |
| `sk-WZxogIxa1O2GQIJ5QdLj4yDToZtL1Vr1sKdfUZl7HiRaIbd2` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-06 | Kimi long-context general model |
