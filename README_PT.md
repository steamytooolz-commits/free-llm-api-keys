...
> ⏰ Última atualização: 2026-06-26 23:07 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-26 23:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-X2SnD0j17fCHTaaLKetkaE5gTrBTLRFPFZwziwt0QEK5UeWM` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Rmo1gzyhiiY3kUqSR789Q0Hp7XXnS8SQCC3kYzObVI0gUmDY` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-26 23:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-fsuyOuCeSn7cgYAvtMcEftHvwJ02Z95q24Gs1LBxw991ZhdK` | kimi-k2.5 | 🆕 Nova | $10 | 10 RPM | 2026-06-28 | Kimi long-context general model |
