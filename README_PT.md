...
> ⏰ Última atualização: 2026-06-15 21:52 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-aOuwTZTjlpcYmQiOJwtaWhs1OD3TYNFH0UyrZU1JLJM0eEKp` | kimi-k2.5 | 🆕 Nova | $1 | 10 RPM | 2026-06-17 | Kimi long-context general model |

### Image / Audio / Embedding `06-15 21:52`
