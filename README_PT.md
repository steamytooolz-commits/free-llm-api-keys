...
> ⏰ Última atualização: 2026-06-26 09:37 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-eRZLgGfxwDesGJHMOsGxSZalFKlmxfsLZAOffRUtIjjfeWop` | kimi-k2.5 | 🆕 Nova | $15 | 10 RPM | 2026-06-27 | Kimi long-context general model |
