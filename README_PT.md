...
> ⏰ Última atualização: 2026-06-25 22:52 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-PMFQPPGT9w19bs4skwqxQ6BzSe4A1ODBg2AdtsHoE1Sq1EoH` | deepseek-chat | 🆕 Nova | $18 | 20 RPM | 2026-06-27 | Everyday chat, coding, translation, writing |

### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-25 22:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-8YcTOmybnwUGimHfXGctvbYtuKNF9b3u39eqcpilgnxPeHdd` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-fjD0YZ3TeZqZTn9aUoodQ7BKBj5ZYTu0iVOrGhumUhq10OTA` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-M3yTq5BquY4Mvbbe8Fussw2OyYDrQJjUsdB83hEemgdwOBb4` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-sqa3Db393NccECImtu62vKgGUDJcj6y7KPdU7SEsXMRYS7gU` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-uk6uzxUA471jA03oajjBGfHVon4A1aYgW80RG25wSy5fV3to` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-iptUTjy5OeJxw5uoRMvWrZD6YUcmO9z6mZPIe3tO80mPtSio` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-25 22:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-QVz0qehVKrkoLrQJkocvtvMTlnKd8xR6xLtkqiuyGqYpnJOk` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-ZCwHZX0wCNRwT3MP3rfl3OgtS37MiE6M3Ac19KXMivafhgmw` | kimi-k2.5 | 🆕 Nova | $17 | 10 RPM | 2026-06-27 | Kimi long-context general model |
