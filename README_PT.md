...
> ⏰ Última atualização: 2026-06-13 16:31 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-13 16:31`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-glUn0OXPEHLfF9SUMloGJXiOot10QbBJaONrSAQRYir6RM68` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-VWjDBa9zhRqZFg5omu8o2V58a3kzEsIOvoy4I8deSjhE5191` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-R4GEOItv7mIrw8192uGBwQmRZP4fqBkDeNTqeSeOzHZsSqR6` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-vLLg4XxGagfmyo9psxIbHqlQKQR54NglcehGZkdNM8Wxtdeq` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-EZgiVkCuNh2A8T6gvu8mjJ41e6nWXhAZLkDAQaXzstHDILjb` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |
| `sk-JcCJzoa1nN5tRiNO7lafK7G9TsA3oBYnGDp4Efr7AcvJZT64` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-13 16:31`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-G4ZPm4HTwiKJOpJo8dOCLGc9trgYxnSwv8zkCFHsvfY1y2jH` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Kimi long-context general model |
| `sk-874U1kHeSu9v7aVv8e7o4gf3BAFLI6eyRIZaxV2szC4WZP43` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Kimi long-context general model |
| `sk-6uL5CCCowM9eV6ZAJZ6n45YYbZifwVLpdWPTJPuxtwkMViXy` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-15 | Kimi long-context general model |
