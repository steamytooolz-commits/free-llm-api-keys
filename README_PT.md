...
[![Keys](https://img.shields.io/badge/Chaves_Disponíveis-38-brightgreen?style=for-the-badge)]()
...
> ⏰ Última atualização: 2026-06-23 16:22 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-23 16:22`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-KLeXLGdmuTYN8Qk9Lx3RxOQ0OoLnk9VGLudyD0LVpqgJVLzQ` | smart-chat | 🆕 Nova | $15 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |
