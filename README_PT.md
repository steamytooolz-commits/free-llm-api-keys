...
> ⏰ Última atualização: 2026-06-25 10:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-25 10:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-3UehWje4qMcjcW2oQTKHjd5NHlhoeFhv1nqwJEZQDHSHMBkI` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Y53Rbmrw4bTiD7YRflBEP5EgSToZlXGFk5avoi6KU6ystl2F` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-DqUNnm3JfQr4vwyv3bEcPvevvUuSUPuYr2TtU0T00azaJ7N8` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-yGcVcZdL8yDf5bzB7X2G0bSoaA3iqUjYwGWgErQJdD0GwWyK` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-DiAKL44eLkfEI8OPDZIfzeBFt5X4W7lcyzhjAsxlOIVlxlCv` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-nWbN03v7G4keme7GzodZ6yDcrhsDhQ2yqHzM8eHxEe2ecAQJ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-25 10:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-eZuls33EiKIKHfS7fVTgY7YkxpyrLLM2f2p76QppR1wrK43R` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-OPjtAwyALj06DAPHiHsTOiw2aHhVR6sLSoWVJMFZt2z7Rh6r` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-gfLkHkXTsHYJq495sdMqzUBPsyNYkpauSO9Cgo64W9kRQcj4` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-4YbrYrRFyJAaCLEExUzpXfXIn7pr4F2MHmmax95dyqykUdtf` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
