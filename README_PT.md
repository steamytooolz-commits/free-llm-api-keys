...
> ⏰ Última atualização: 2026-06-19 06:37 (UTC+8)
...
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-V5aQ7JS7VJFRnsdkl17bpiDvWpZFD2cgminJ4uSwNmW5lSm4` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-20 | Claude Opus flagship |
| `sk-nGnzCVmvNgXA6QrBBfsOehFzOoXZNfyMbUN8qL7yi4FiswV7` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-20 | Claude Opus flagship |
| `sk-4fNBOIwbUez0zJMdgpeb7oabnqPGqzPgcel7YiapSIVS4vVO` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-20 | Claude Opus flagship |
| `sk-AdCm4e6bImaI32AX2Yqzw3cY2BPXl7M9HdVGWhdgyP9zLu1X` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-20 | Claude Opus flagship |
| `sk-W4pXgauxXyijx9I4InJ8E76syfiRfv5P3JRjUClTG83ydjLk` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-20 | Claude Opus flagship |
| `sk-0uF668aIc5FRWHwNX7XMMbgG4ixsgtvQEcAT2Kd8ZfMtA5qQ` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-20 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-19 06:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Ds5YtYWcg8hSVBYBzinMXnTOoriyN7CbKx9mMJSIaEq4VSmL` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-zdNRLlo6YMcrjybditgHXN41JWHbZwN5S5Guds5xgBAQDnfW` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-gDXyVVQoIBXPVxyLFTgmYbr2WOZxoVIMvDd8CO3KRLa9uB5o` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-anYYAAUDjKc5Vjfs7v0Capju2AbhLRR18pyMpTh44eGbAEQx` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-RXif3nZkMUcnr7YPKgAjJ0VEV3f85r5HEBrWSm1pYhB0IkyH` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-x5J6ItCEjvL2iwV7CGp7oArjE4zVLdXibWMS7IMCFKMT15at` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-19 06:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-BqEoe4lOH9i8rfOrwC4YCZ6R4wCH5GsWCoaChfVKrR496meC` | kimi-k2.5 | 🆕 Nova | $13 | 10 RPM | 2026-06-20 | Kimi long-context general model |
