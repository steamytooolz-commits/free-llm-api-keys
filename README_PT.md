...
> ⏰ Última atualização: 2026-06-03 14:31 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-QoZC8vjH13DzyR5kMZgOw9P6AvGmElc4rhB5e6BhaseqHlVY` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-qG3qR4tOtbMhitE9yBx5tZAsVa87SuUpFjiHsUdrWOM642o7` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-8TYoBCcI70L9BwTmj9HUgp53W35LZdcQeYx7H5nB6ZGEvONa` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-xXmQ23nuHFjyCHXFDAKy6mg6pqKtE2kX1tLC14CYGyWmUrw4` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-03 14:31`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-fwV9FzKaInDkO2Fbha87ca5wLo6fKNkFaf2IWyPAPgTlLA29` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-RYxkZHlllMdiXa3HHFDnJTg0IunZR1CELZmkoVwA67bKdLXW` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-ieXvXSu8eSAZFEm09BQgDa1ImSRBXegH3w5tYwH0EzDvUqRd` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-jo20XraFiTlvFujqXAk76p5lh2jJGNxBWkXg4GlNcZB4DSbH` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-50xaHcMJyG2mLhYvH7iYXrLlbVcbWfxt5rPOSRSKxwCocE4b` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-obyVDzc9CxA1wP8IRCw996txp3ONPpGTewD2n8R4YjAD40s8` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-03 14:31`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Y0zUkkiE5V1pSZhvUShjx3VbVJYWScaMi3P8WeK08LRg3r8X` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-J154IFIPzdDThWmV4ZSV1pYHfMg0oXLzfGetNw9bMGDXyWii` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-4fhUV3FpkGNSg6uJ72s3d4TMDi4iIZxLBoozpZmlRUressIY` | kimi-k2.5 | 🆕 Nova | $16 | 10 RPM | 2026-06-05 | Kimi long-context general model |
