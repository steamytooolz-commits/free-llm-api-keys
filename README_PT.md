...
> ⏰ Última atualização: 2026-06-14 16:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-14 16:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-JtJiHJFo1BYMxXMiEO8Jmfu3u5yzRRNkVrgnyl7OI3FYmbex` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-SmWKgnOAQNgCfrW1PKbkIHlQuQaDEbUL7HULOWK0p2WTwZBZ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-enTwoffiXOCsjFa68hL9LaggOlLaeFpih6Xp0JUAxLxTBfLU` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-WFiL0dJ0AndXINNS11xnQpavdGpjQXjzgfMtMkiOpS2sks7w` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-wO6rm92aVZYS5FP7inDSPZWBRjxy5gILkoZUL5feE9kUkfkP` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |
| `sk-YKtTqNCf8G5PgDzNEgOsIyVu5ZeC178gexnUx23SLiMeJX7r` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-14 16:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-buq3wks64kagO1aKM1U8TrIyNCCxov79xHQOD4AVeVtl7dqx` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-16 | Kimi long-context general model |
