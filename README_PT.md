...
> ⏰ Última atualização: 2026-06-08 12:30 (UTC+8)
...
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-kfsu12y8ddIN1zIvD9jl6q2m2NiJEp6nl5Pk0CjK05Mruo0G` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-08 | Claude Opus flagship |
| `sk-IbTBMxQtKBOMj5ioC5I2EmAuiHACgjWMxenXBl1K4727su8b` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-08 | Claude Opus flagship |
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-O3kEN936mtOOgGn79NHccA0SaHTaobDU2oyQB0EkDJLX1fNH` | gemini-2.5-flash | 🆕 Nova | $20 | 20 RPM | 2026-06-08 | Fast Gemini option for long-context general chat |
| `sk-5qdZN0WFcYioCrH4XoujlE9r0aazG424rVXvtyoOU6gVyLXQ` | gemini-2.5-flash | 🆕 Nova | $20 | 20 RPM | 2026-06-08 | Fast Gemini option for long-context general chat |
| `sk-DO9v1g8TbSETRkq7rhY3N2Nb2jGqtYvGJDFcn5iOF1amjiYe` | gemini-2.5-flash | 🆕 Nova | $20 | 20 RPM | 2026-06-08 | Fast Gemini option for long-context general chat |
| `sk-rgW72K3SmyDfDKXnPoGZ55BocvoYcS1Eb4jraUHLoFlTu28V` | gemini-2.5-flash | 🆕 Nova | $20 | 20 RPM | 2026-06-08 | Fast Gemini option for long-context general chat |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-08 12:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-78NBEzqgTPWI8VvgkDELc8epwr25Ja3vzWrJoUnDpKriqa80` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Auto-routes across currently healthy low-cost chat backends |
| `sk-o7IpeYx29fCAAzpA19SBzdXcHpTW1Az6TWYrEJgG09y4ncDo` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Auto-routes across currently healthy low-cost chat backends |
| `sk-fmWLuNSDCdjrTCOA8CW3ZmxRRMESGAZYyvfLX2p5SM3ZBAWg` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Auto-routes across currently healthy low-cost chat backends |
| `sk-WpZ7lUgAv40AS2UKIwkPoQRxNdvqej3qBR8l3jKDiu5YeNi5` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Auto-routes across currently healthy low-cost chat backends |
| `sk-vzfxIuyO8sXKtCoaWjZKoVeQkLxbVTcCYbon2QT0OLqeOCci` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Auto-routes across currently healthy low-cost chat backends |
| `sk-lSdSNyOw4DGTtDbMtNVkCFVL6GAHIcaRtuZSRRvAEPF5SlkX` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-08 12:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-JIXXjXeMe96iGvdJiWfVLmb8dKuWx1EimGsprCjFHX3fbWQF` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Kimi long-context general model |
| `sk-zL18ctzCDckg3W69bIGfRL5Z3yfWKwaIpBkjwThsnzm2EF9m` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Kimi long-context general model |
| `sk-bftGQI44w7u4YMBTe5vjduOwmY6CLIV3vLNhJMn8RF3C0obC` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Kimi long-context general model |
| `sk-mrMaUxBsAwXAuEbqFncHWJ9wMdhy6TRpTHQjKBGe1S2w3EER` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Kimi long-context general model |
| `sk-HeQ98aniqeetyVMufWDzYsMrPyY3MU1vvcrBI8zisNV8FgmF` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Kimi long-context general model |
| `sk-pFTGAXLHDJdXXXBJqvcHwjbVDRT4bgTEfNhydXRYMkdUcr6p` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-10 | Kimi long-context general model |
