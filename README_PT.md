...
> ⏰ Última atualização: 2026-06-22 21:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-22 21:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-fv3HdmmlhgCu6fSq2Z38VrgP3boNJMaqY7HsZ9TNXxN9NUpw` | smart-chat | 🆕 Nova | $11 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |
...
| `sk-2MIwGZcfrraAeG7a3cuQ9ABaez2J4dftJtJSogDuDsbZYpps` | kimi-k2.5 | 🆕 Nova | $16 | 10 RPM | 2026-06-24 | Kimi long-context general model |
