...
> ⏰ Última atualização: 2026-06-04 00:52 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Q6HumpeDtSycilzddPTnAIGReF4bJ8YDpgMFuLF0CIINBTzq` | claude-opus-4-7 | 🆕 Nova | $17 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-caUEPKUREw2PXjc06yxyqHhJfj1eqvOsHfby9vvxtvIk6F3S` | claude-opus-4-7 | 🆕 Nova | $15 | 5 RPM | 2026-06-05 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-04 00:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-8kbJgMIw3Ee709xlOUqfbIRzBWegl2g1nHJgeyLcw48i5JUn` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-gocNFfquCAAK7JgNvuTgvU3vpHKCXouJ8dVi0Dt2MysUoPC6` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-BcY6ts7OQIYBtjeO9G5FvAHrCfpGNBybbrhKFTUvGVFmDYkL` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-vhJufghic9UYx3agUAA1oCoCk6xAUtMY88KqzZYZVFgMdxTX` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-NvUEi15RieNke5qilq8xyXuUwV0wbDvBlI2Ulu5arfBQEBTe` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-04 00:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-T7T9OWcg6IQeDj6M7EDKzJ3VPPH3DKQSrIjIcKBioAyYRpZx` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-1WYGOGxUpOp9dtAP5DDJX9uZ9tzgJP5jCLEJSknyot5dbWYq` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-4F5QmEbhLhqckK1w4b8CZ8QXyH8B2oDYqWmm2E8eLjQnHR3M` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-7zXJuG10M0h8HAbgIfmUNqrByLf0mHFtn527zuwe5ScSfufB` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-N7WpNZjcgyF5y3bTKBzGt4PNODXBOnu90uToZCfzCLItkTQn` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
| `sk-iAYacwzQq6Ca5MMH1dKUNO9A6pL5PVaYATNCSQWXa8fcxgHX` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Kimi long-context general model |
