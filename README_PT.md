...
> ⏰ Última atualização: 2026-06-14 16:52 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-14 16:52`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-buq3wks64kagO1aKM1U8TrIyNCCxov79xHQOD4AVeVtl7dqx` | kimi-k2.5 | 🆕 Nova | $0 | 10 RPM | 2026-06-16 | Kimi long-context general model |
