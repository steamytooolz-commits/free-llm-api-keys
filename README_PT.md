...
> ⏰ Última atualização: 2026-06-18 10:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-18 10:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Ty9xY1vn6hHkw0pr61ViN18tuigxNPnJ316RWKppmpKzvzzd` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-N2MoBXhMOQm1KhNynkWUnrDRcvRUNRsREDvpmo9mL2fxjgKI` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-LV95f5lVuzGiqsvhcwvRzjjg4oPIAg6Dn4nK6jm85Klr3OPT` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-1sNeKkPzmqaoGUTFCLdQKwk3h6lYLeQ4zTxQsfi4aPTANRLW` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Lf6aDdfuARelBCXy06qkYCDNhAW84cx3EI9y5LyXaxVWiCD3` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |
| `sk-yh3RFxja62BGTpDkH723lKyZuxti5y3MbyDtuTBfqWVsVWUY` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-18 10:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-QpVVEStiAeK22iiGb1tnkxkHuNnxXWcUQXVk4VT49DftzmJ5` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Kimi long-context general model |
| `sk-K4ViA4my0qEfwip2OncNXirhEdP928MrOQQey4pPDZHuz7wN` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-20 | Kimi long-context general model |
| `sk-741F2Iv6VDbTlbuPIHulG1ApgG9HCCsITxR94EiYmq059Keo` | kimi-k2.5 | 🆕 Nova | $10 | 10 RPM | 2026-06-19 | Kimi long-context general model |
| `sk-RTwzxHNWcDtwjgZuIBlAEAG9TVAS1tg7tiD6dfcdmVk3W9P9` | kimi-k2.5 | 🆕 Nova | $18 | 10 RPM | 2026-06-19 | Kimi long-context general model |
