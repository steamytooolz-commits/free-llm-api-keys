...
> ⏰ Última atualização: 2026-06-17 18:52 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-17 18:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Y9NpFSH6huDl9Mu6x4Ap7mShbLV3HlHzD8SgyrwukILH9Dmy` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-19 | Auto-routes across currently healthy low-cost chat backends |
| `sk-9W3PZDmk2YVfi5QPV0ZR4oXJy1oF9GA5WIQHph3tuTBhL0uD` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-19 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-17 18:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-EQzoUXISOz0bplXTy5DtIEh805pr0TfUVtd79gZnR2MChRry` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-19 | Kimi long-context general model |
| `sk-xpTi7NTXlwwRNfmNS1NetNYHeFiZQmoeAYlh0J2VLEZAjTP7` | kimi-k2.5 | 🆕 Nova | $12 | 10 RPM | 2026-06-19 | Kimi long-context general model |
