...
> ⏰ Última atualização: 2026-06-26 06:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-26 06:30`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-eRZLgGfxwDesGJHMOsGxSZalFKlmxfsLZAOffRUtIjjfeWop` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Kimi long-context general model |
