...
> ⏰ Última atualização: 2026-06-15 08:22 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-pLe3EY55e43rTdPK52cN31D1EE8F6Y6rIfBDWNIgVFORGRln` | kimi-k2.5 | 🆕 Nova | $10 | 10 RPM | 2026-06-16 | Kimi long-context general model |
