...
> ⏰ Última atualização: 2026-06-07 22:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-07 22:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-6jYvoXffEuX5wtGpEeq6PC7usTALYrnzAT6YMBH9rTnybbw9` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-erVbwhu3NbSOPPYSvLnhajj0EcewJmUi2JQsCeQAxhLCIlBe` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-nBH9i9mYc1BcXIfDOZuKwUKgdrEBHIBAiWeY3KYxPgP5JCvA` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-uAAyoudMQbMXbxvtJ8eIa9m9AgSF4xoMS9qjzv8hKFLxWDwC` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-5XcxAFPeNR6BhKdASSzorciXCYhbWHi5kP0zHTtnIbQICUfQ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-uNr5IntejQeL5If1vdEIq6Eh6zna97VKeaNcpEyfY5OFKIfj` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-07 22:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-CWv34aVDyPPCqqDOIf1vp9Cw52jtPsvvoAtM3SdrcJJlyIUA` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-ELv809fhMg4LodrmHorZozOhZURW1Lh89iMpgJlk5E1bjGSM` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-3kB7S2ZlrfQuzK9TuwHvZy1aGFQJMpLm88VaKPwLFbdDDlSf` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-53py6xlTJqmf6MadY9u3CMVAxGIOxcrkC5yNpYC72fhllEdw` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-9k39V9Eprpj0t6dNqwUHE2LvM0Mbllr12ClFgnckldGGrNrt` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-bPhgTNUgQ3jtRlJ3mcxJtMYk2EvgnXTylR2g8BrCDDDDjbjJ` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
