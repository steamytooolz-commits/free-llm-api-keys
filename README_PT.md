...
> ⏰ Última atualização: 2026-06-03 18:52 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-c1dtBiucGilp2ckXG4NaLbWJ6lWKhKCyzMJ7PhxaDgOSVvVx` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-xpbVL0y3HthcjovSnaTUIUaSiaJA1aaLMzmnPBMGF0IThPhB` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-e6cKorvV1oMBDLrkWmEa4jfIY34bCbKQ2Z5QcfGoaolXcIJy` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
| `sk-sjS921jvK5jtv8c0wye7kRxbuHMnNn2tnAXWFcTbwwBdN63E` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-05 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-03 18:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-hbUh5LfzDqZijSxQic6R8UYESdwEFYwxDJZnXz7eL2iu8YlX` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-xmdA2DkSYZe5TPpPWoXYRRQZHiObGILbM10zYLqteLwOPWCM` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |
| `sk-kbLS4aNpGWVCcBJMMGYegqJd5z6cvTY6hRVRqw8YdCvozNt1` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-05 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-03 18:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-qpBqlIeeeGdDYc0xFENfL1bBO1lk9hnfbAptQeTX4dK3UE4M` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-05 | Kimi long-context general model |
