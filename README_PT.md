...
> ⏰ Última atualização: 2026-06-24 10:22 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-24 10:22`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-nm6NX28HrZRjEovS7TEAqYzyxqocuCA6bDMuBBy6XKhWLsu0` | smart-chat | 🆕 Nova | $10 | 10 RPM | 2026-06-26 | Auto-routes across currently healthy low-cost chat backends |
