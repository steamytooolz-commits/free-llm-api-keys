...
> ⏰ Última atualização: 2026-06-18 22:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-18 22:37`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-uTVlRQdN8XcjIbY9v7rhTGch3feWobyQ1fHkQ7pwI5SLb76V` | kimi-k2.5 | 🆕 Nova | $2 | 10 RPM | 2026-06-20 | Kimi long-context general model |
