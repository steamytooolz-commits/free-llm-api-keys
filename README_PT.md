...
> ⏰ Última atualização: 2026-06-26 00:37 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-PMFQPPGT9w19bs4skwqxQ6BzSe4A1ODBg2AdtsHoE1Sq1EoH` | deepseek-chat | 🆕 Nova | $17 | 20 RPM | 2026-06-27 | Everyday chat, coding, translation, writing |

### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-26 00:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-WDM656z5BOSg3mhEysnP5O5eXiI8ICzQskWK7O4yOnMsfDc5` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-w7JsfzW78ZamqZ2B68ksumXkYjkUgUwyG3MdcZZBYYkEIZuI` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-WZaxVrNXk3zBVM5yurEvw0HuPR22mxcCRwV4332tkjpET9db` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-I1CHQtC0R4pBbJyEJjlTeJENv94f77mIaXTlZSNy5vGmH7kQ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-jfS8u56iSiiDL1YVwlyiMR1y8t4DgjMTv7MQFTaXSSqYG3kx` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |
| `sk-ahjDef17h6EO1x6P6fYzdU0cp0EeA2TJtmjQyqd10Go8VylN` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-27 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-26 00:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-QVz0qehVKrkoLrQJkocvtvMTlnKd8xR6xLtkqiuyGqYpnJOk` | kimi-k2.5 | 🆕 Nova | $18 | 10 RPM | 2026-06-27 | Kimi long-context general model |
| `sk-ZCwHZX0wCNRwT3MP3rfl3OgtS37MiE6M3Ac19KXMivafhgmw` | kimi-k2.5 | 🆕 Nova | $13 | 10 RPM | 2026-06-27 | Kimi long-context general model |
