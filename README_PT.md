...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-1AJJ3PqVjs8UR5GwKiC7GXwpTSpUDP5c0dUwh5wOXJ9mblkc` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-01 | Claude Opus flagship |
| `sk-fmHaW0bX8ZjXG1tJq3ILoOIAPf6qMbSI1dkdzW4e1mraCo7Y` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-01 | Claude Opus flagship |
| `sk-2XckjRM0anm2mf6rb8fOMzgGw73XY6cMQ6ULypdXgovPDZEA` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-01 | Claude Opus flagship |
| `sk-IdBm7h5phVY2GruBOI4kxqIXGwDw1e7Y1MaqNeTB9u9qEPEs` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-06-01 | Claude Opus flagship |
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-gyIAmz1hJgG1VFZXPPPM07pjJ3WcFcCTwqBim5L3K0VaD81L` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-SpTU60P77IzXiGZXOvxfHYYQkszjbVaMVYUtZdePx0wAInmX` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-6I0ki3gCG07hziBGa5ufHVhVYvcsDWbgyMS6dgnUfnY4kJk0` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-lCzDeS2Cw24W3WYEbuevF2eBiNHVDbMyCsKTZFl54gmLkniT` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-AUlnabnzEtzah0fX4TkziiKVIq1083knP8N5qWAZAY0DEWId` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-2B0hZDFhYARUFwhIBLWGTVB8ov2SNq0M4yYTEw747F4aj5L0` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-0HguvN8BuPehmjKNNHjI7on8rRW01QBZxhzYF2CJWbVBmYXK` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-POBB7T3CiI4VmY2w2UkxuivxSHp5D9hEYjEkQxGLE5ymcKPz` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
