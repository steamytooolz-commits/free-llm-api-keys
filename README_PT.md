...
> ⏰ Última atualização: 2026-05-30 14:37 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-X856ITH0jdtxky9qevCFuzzovpqDzAtEHcpnNV1uHyqAKxk9` | claude-opus-4-7 | 🆕 Nova | $9 | 5 RPM | 2026-06-01 | Claude Opus flagship |
| `sk-W9lXNDepkbupHbQwsngJllcAN9WwKm79M7qvkxNTQBvkbRNe` | claude-opus-4-7 | 🆕 Nova | $7 | 5 RPM | 2026-06-01 | Claude Opus flagship |
| `sk-ReKKQHXD1GBR1zuwjogiyJgOhS5eztHMI2AN8EIpQnBppZUA` | claude-opus-4-7 | 🆕 Nova | $9 | 5 RPM | 2026-06-01 | Claude Opus flagship |
| `sk-8FlnIOCVtFAfzmw4t6IgHu68CUDItJInURa3PfHq6g72zFde` | claude-opus-4-7 | 🆕 Nova | $9 | 5 RPM | 2026-06-01 | Claude Opus flagship |
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `05-30 14:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-GsndKZ9HYu5NCGgJ2yztB6hnpRMf72aExR413KpLC0BIJSm0` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-3gBICzCrXS06rQZmq9W2Zq9fa8tjNanigqQM5MZCBDdpo0yF` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-YqWDw8mGEC1ocdNdq29x13sfzf3jfHv6GK56GUcILpLpyHqA` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-uES4GTwOA6SAsm47ePHpCOX6F2XqKyq0kCfdR3j7CBPPwHbG` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-mCKATKHkWa77rHpb41vjPoTOEgyGyNCRHpBBCY1aUX0PSqk1` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Z3OnC13Oes7s1ConXpytm8nXGgOcxw7bETtdTqUzQWJktlnd` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `05-30 14:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-dgpDywOhSNIo69vlxRFW6TLPeVJn4U3t9M6XZxGRLT0yGOGu` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-dFwyVC4qVG4ahMrXMshWLpN6xBgSDTmBENWJLWwl0ODAW4L9` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-aMFeEOXNdi7HWYBqBwioEHptB4PhiR63AlUsqbY54AZ6jCs3` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-zPpYfantX2QQZsy679z68kIweu5gsmfZ2NFgE6tXBu7kJU38` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-VDMLjTsj9mDgq6Efb8yd3jW9I2c5fxMDuTLH8ozX15EL0l70` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
| `sk-Z8YAmXYqYFp5Hym479guro3nVeWPVQubew6j4JeCwX1kED1U` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-01 | Kimi long-context general model |
