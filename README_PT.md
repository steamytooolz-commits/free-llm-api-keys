...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-HR7T9QlJVcN5rufNgKlGN3MmXcjAGlMu0Ky0LcRSQejagI3o` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-05-31 | Claude Opus flagship |
| `sk-I5ZHOvl1t5cWiui3u8ZN9GdREn8B56npmUBwiNs9aTWGU5hH` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-05-31 | Claude Opus flagship |
| `sk-CLwcgQxAPhZjjg5JlOnajamFXihXvT7XuRvZREl2kSyth40D` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-05-31 | Claude Opus flagship |
| `sk-HGvvJ2azs1qUZpMwuDapOBdpOZ4EqdtXxmZ11WprJiZdmq6n` | claude-opus-4-7 | 🆕 Nova | $20 | 5 RPM | 2026-05-31 | Claude Opus flagship |
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-ZGWo7UfIZxpsivihyUpddESq7QzXTwU2kH3vjfoyBGzIOS51` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Auto-routes across currently healthy low-cost chat backends |
| `sk-1ZZ29GuA5xIUA6NCPGd2dWEESEd77rqabIQXQDZvnKspyyks` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Auto-routes across currently healthy low-cost chat backends |
| `sk-zLRoXHE10pmXiC9J5GUgt1lSR5OcEDNjAOFhbS6j019Rkk7l` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Auto-routes across currently healthy low-cost chat backends |
| `sk-qoOR1js6Ax0ildNEPHgwZGtBtSUz46ceJux6dCnA6riWOZ8o` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-RIStJIrLqNGrp5soyWDYp3DpYxa9LHIPRH3u19rjhKfXk8XN` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Kimi long-context general model |
| `sk-JX571vx9hDobpUnU2vgCpsnOqKQWvBBBFORYNjsB3l81V4VQ` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Kimi long-context general model |
| `sk-atEqnqyIBtEuI3XMJoIgl0deEQG06Ymus0wxSZjGNCissD9B` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Kimi long-context general model |
| `sk-7dnetQUwxsvFgBlDnKB2PIASoCnfujZbXDqryUFltkWOAKsd` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-05-31 | Kimi long-context general model |
