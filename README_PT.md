...
> ⏰ Última atualização: 2026-06-18 15:37 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-vBO41o84z6edV9WDDKp2v6fOsSKVezYvn91WtPHbLmiIPy11` | kimi-k2.5 | 🆕 Nova | $9 | 10 RPM | 2026-06-20 | Kimi long-context general model |
