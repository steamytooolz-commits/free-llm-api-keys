...
> ⏰ Última atualização: 2026-06-26 18:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-26 18:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-6af751V03WuZQTNQEJx0LopbMaxoLiOHMpyfesfhZ9jmzGky` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-suZuULgZHskvYHBAEewfQA6CKLyXANuUF7kv6abMmiRDQ3ml` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-0VWIA6rZ8zkAsjKB9mQzZ5VtvCE1vp60gVjGd2a5NAi5T4X3` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-1DwnuAXBMIHKDaUXCYT0vHuYIPt6tSd8u3IvzxxbVQL9E186` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Bd3NumxupnqZIDXYU83pKrViTUAyXnxttpd0O4j36PSgT5Nd` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-l0cMvEAafWZhlX9rNN3d4DWyNnH9PN6R8xnH5REcPPK36gQa` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-26 18:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-YZGizInCslHwgOV1av7jEmn35JiAlo9nEMUiowz1A86aVfMF` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Kimi long-context general model |
| `sk-9EQxlIDfhuJjiwcdM0mKp5VU0CCP32u6NTFif3zwXBMsVdW8` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Kimi long-context general model |
| `sk-a01zzOBue4NvTJSOGiI1G9MAZnDw2UCmMU0Cmvs1jhkByN3S` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Kimi long-context general model |
| `sk-REer3Tq9CAqNDp6WgGhMCqV099jMkRPyJs8IhWaNo7NQAPWj` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Kimi long-context general model |
| `sk-A9iMKIzzx8t5nxdorsEdyEiyJjaoYqttlLC1kOHBhtdzJH1C` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-28 | Kimi long-context general model |
