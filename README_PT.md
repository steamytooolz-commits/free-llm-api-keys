...
> ⏰ Última atualização: 2026-06-21 16:22 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-21 16:22`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-1FpKdyrjcFy8yrTL4hiEeFj1eyQMvQEmwby6LNSc5DlcBFzi` | smart-chat | 🆕 Nova | $16 | 10 RPM | 2026-06-23 | Auto-routes across currently healthy low-cost chat backends |
...
| `sk-JR6ifBwYb5pPHyn21eArkgSaxqRp2VIkK4UvYKabv3DjtsGe` | smart-chat | 🆕 Nova | $12 | 10 RPM | 2026-06-23 | Auto-routes across currently healthy low-cost chat backends |
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-DwsmaMifsqH9B6QymkC5E3evwpPTcNS4fQXXi0lyLvhuw5Fb` | kimi-k2.5 | 🆕 Nova | $15 | 10 RPM | 2026-06-23 | Kimi long-context general model |
