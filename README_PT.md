...
> ⏰ Última atualização: 2026-06-16 13:07 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-16 13:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Xw9wn1vzi61ByejLNJRyseBe38eEYOFIHXoQnzUHrxSWt7OG` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-18 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-16 13:07`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-7eUcIZCTMv1kq13dFpCkzrlfsbiNbDUH8ACgEBcQlplwrXIM` | kimi-k2.5 | 🆕 Nova | $12 | 10 RPM | 2026-06-18 | Kimi long-context general model |
