...
> ⏰ Última atualização: 2026-06-11 00:22 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-POPL1XCJ3QQqcf02iX8F3BwUXIuug2OCh7vEQzlIxAwel4rY` | kimi-k2.5 | 🆕 Nova | $12 | 10 RPM | 2026-06-12 | Kimi long-context general model |
