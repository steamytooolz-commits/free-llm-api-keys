...
[![Keys](https://img.shields.io/badge/Chaves_Disponíveis-41-brightgreen?style=for-the-badge)]()
...
> ⏰ Última atualização: 2026-06-25 20:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-25 20:37`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-T9WbdXCwm8XPwSXD206xawF6DkS4MezckFwlerETDR4ZzU1T` | kimi-k2.5 | 🆕 Nova | $13 | 10 RPM | 2026-06-27 | Kimi long-context general model |
