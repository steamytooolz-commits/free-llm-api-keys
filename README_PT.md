...
> ⏰ Última atualização: 2026-06-07 12:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-07 12:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-HDZrZmTO8Jyn1UQAAym5ld8hBStwpuq2KbsyztUQrMjVO6ar` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-OASDGMJ3fVJEC0DadETCsHtXePV4YRxT2cIi5JQSvY2zgRTI` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-8PNijP38Y96VJzTghObAAWZdkTfSy02ASKPcY68XF4b44RKf` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-G12vfJRqrLvHAdNlIVeUzwwRMDxyhLRVRiH46gMNvANlVopZ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-EcMgsCnClcEWK1BFe56i1zbVbkmgJkXID6SKLGCKF91zvGSi` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-mY0lhCowNv8dKYtRm9RibhLNWtCzjzTj7NTjSTvYGcS8YdPX` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-07 12:37`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-5AQCcrxviM5R2h0jPLmCftslGR3HVLeC7qVgyLPMZBHw7LvJ` | kimi-k2.5 | 🆕 Nova | $17 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-piywiPn0ZF0zbgDgghAfmrIpUQElOi8GEOUhmrWPZp9sydZ8` | kimi-k2.5 | 🆕 Nova | $17 | 10 RPM | 2026-06-08 | Kimi long-context general model |
| `sk-B4wWCWuDlReq8sYiZh8QofSTI0tYkuQrDxgFuzkTQUZv4qF2` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-08 | Kimi long-context general model |
| `sk-Tf2tTQh7sxTtZ73lVHiaBIzx7A0StkaoeRtdTiwZj8LoDUET` | kimi-k2.5 | 🆕 Nova | $17 | 10 RPM | 2026-06-08 | Kimi long-context general model |
