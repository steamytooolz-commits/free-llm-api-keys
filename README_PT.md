...
> ⏰ Última atualização: 2026-06-07 20:30 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-07 20:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-9Qmoijsq2Ty3f3VeJDKidpNdmDVejMnt1Rp8HIGiHBf29fH5` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-vgETCmYagldBKy6tZqGBT3mmNKki4ARSkJVZ7XdzAe8qsdFC` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Q3bZ99lB1FbByeh8sgik89R5pe0Ddwnom7K41RPXA7im5BvA` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-csxdnPrNZTLajezlNG75jBcxUthcOKIjpFdeboPUxCq6ZPXB` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-NQAmdW0JLreZLDCWchoPiDQYYVEjDatVKoKaDY9xULfZCjp4` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |
| `sk-zefdWOnVeH0Ga7MeghXnl2N7pOQXbcHwiyTbKWFCxJ0CvkGg` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-07 20:30`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-ceGOZNafRL3ve7bIJFI8YcFpjyqVtrXxiX1b7tC2SN3p4dUn` | kimi-k2.5 | 🆕 Nova | $20 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-CE3TiUVnPIuf0wbCqCRMwR1rmg735oJqUlw02gcHGlqPEuJC` | kimi-k2.5 | 🆕 Nova | $10 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-lxdpx2fX3CAV0ujgxkN54xitHepRm46mklsJRuENXzxs44QL` | kimi-k2.5 | 🆕 Nova | $16 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-OCZJxKJE3N97JkcKwrr6C72ejOp3Kjjzn4qYooFugosBi2Ht` | kimi-k2.5 | 🆕 Nova | $15 | 10 RPM | 2026-06-09 | Kimi long-context general model |
| `sk-64D1SgRnoNpDjO38HbpgHiw7slemsc1xCwAypnWTAUFNTprq` | kimi-k2.5 | 🆕 Nova | $14 | 10 RPM | 2026-06-09 | Kimi long-context general model |
