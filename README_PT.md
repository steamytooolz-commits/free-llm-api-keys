...
> ⏰ Última atualização: 2026-06-06 18:52 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-06 18:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-8TaLnESyVi98gjdljcnvYY7IoqIrxw6F7PvSkHrpc9alfgdj` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Auto-routes across currently healthy low-cost chat backends |
| `sk-BkOaDBMBKkpLzdesJoadRk4ocJQHIDP8b7PiMeTbDUrqadvJ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Auto-routes across currently healthy low-cost chat backends |
| `sk-TbdBlWaznEpiwydBGjw4Goybz9zRXAFhKGazleLNovYkhdoH` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Auto-routes across currently healthy low-cost chat backends |
| `sk-cKiuYeu3wStqGNzFwcti3QOambyc5oU9ksvmShQtsaXvXiDQ` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Auto-routes across currently healthy low-cost chat backends |
| `sk-ATSGmZvi1QE9WfbIHpfA6pfnY17gxmGlsJrWHFmwns5YKH3H` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Auto-routes across currently healthy low-cost chat backends |
| `sk-0RRsekt8QIKMsFXtN8IwbbRLuLzMBomncSESVwWyNKBHRhfA` | smart-chat | 🆕 Nova | $20 | 10 RPM | 2026-06-08 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-06 18:52`

| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-YWwaHacyEiTJvQMXTk0Z1hhiUg2lyMhfOwyfhEiasbFKwDOS` | kimi-k2.5 | 🆕 Nova | $19 | 10 RPM | 2026-06-08 | Kimi long-context general model |
