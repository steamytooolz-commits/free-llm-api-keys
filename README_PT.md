...
> ⏰ Última atualização: 2026-06-17 20:37 (UTC+8)
...
### Multi-Modelo (GPT-5.5 / Claude / DeepSeek / Gemini roteamento automático) `06-17 20:37`
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-EQzoUXISOz0bplXTy5DtIEh805pr0TfUVtd79gZnR2MChRry` | kimi-k2.5 | 🆕 Nova | $9 | 10 RPM | 2026-06-19 | Kimi long-context general model |
