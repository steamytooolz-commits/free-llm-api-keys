...
> ⏰ Última atualização: 2026-06-26 17:52 (UTC+8)
...
| Key | Modelo | Status | Orçamento | Taxa | Expira | Descrição |
|-----|--------|--------|-----------|------|--------|-------------|
| `sk-Eu33ddiMYxRYE1LJxUxLgGCiRSmyzoEzVefHQQnGOCGvCCZr` | kimi-k2.5 | 🆕 Nova | $4 | 10 RPM | 2026-06-28 | Kimi long-context general model |
