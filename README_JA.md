...
### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-23 16:22`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-KLeXLGdmuTYN8Qk9Lx3RxOQ0OoLnk9VGLudyD0LVpqgJVLzQ` | smart-chat | 🆕 新規 | $15 | 10 RPM | 2026-06-25 | Auto-routes across currently healthy low-cost chat backends |
