...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-0RxhMRREJ9qqWhEv0xz1NDHJQiuRECfusSouLjPunmUzCGOo` | deepseek-chat | 🆕 新規 | $8 | 20 RPM | 2026-05-26 | Everyday chat, coding, translation, writing |
