...
### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-12 18:52`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-7XrOTSqPRQBUxxCESqP0Hj9nNAHr63jvDnJ0c1d6sY7Taqoa` | smart-chat | 🆕 新規 | $20 | 10 RPM | 2026-06-14 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-12 18:52`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-iSjuGoUBU8ZqUqvekcYBsGnshkCEZmzyPuo73K9b6xhpe1z8` | kimi-k2.5 | 🆕 新規 | $19 | 10 RPM | 2026-06-14 | Kimi long-context general model |
| `sk-EgSBpjizK1FE3fIl7vUI5GosaRVqwSEpf8B7B9OEZS2R2ECI` | kimi-k2.5 | 🆕 新規 | $19 | 10 RPM | 2026-06-14 | Kimi long-context general model |
