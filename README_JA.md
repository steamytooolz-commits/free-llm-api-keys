...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-3jjz4wD3guRD9KAdap0vw11fU0f9Tgd3Cjh1Zp5b0CFVo6vx` | deepseek-chat | 🆕 新規 | $15 | 20 RPM | 2026-06-23 | Everyday chat, coding, translation, writing |

### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-22 14:07`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-KeaxhSBwCkutmklkL0B0DVYLzTN9IGtRp1j8IScPi3GDHJgr` | smart-chat | 🆕 新規 | $7 | 10 RPM | 2026-06-24 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-22 14:07`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-25oZ9RPiF3FMMwIEBuGmDcwidYDpBHVTxhGha7y2dYPUOqcI` | kimi-k2.5 | 🆕 新規 | $8 | 10 RPM | 2026-06-23 | Kimi long-context general model |
