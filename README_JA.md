...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-CmToOGwbsBwvHCTEBLKnRnf2OxVe7LpXL7k6RPkHbPWniy5u` | deepseek-chat | 🆕 新規 | $10 | 20 RPM | 2026-05-28 | Everyday chat, coding, translation, writing |
