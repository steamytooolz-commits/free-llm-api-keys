...
### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-11 16:52`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-PKgtVPfLnaJmfAEO4KEijnkpht6GxHJZwGmE1pJV49nmRMma` | smart-chat | 🆕 新規 | $20 | 10 RPM | 2026-06-13 | Auto-routes across currently healthy low-cost chat backends |
| `sk-iAXB4lXf4wbS28267Qk8VVNg6BaNP2dv5ZTQLI5qD9onOKl5` | smart-chat | 🆕 新規 | $20 | 10 RPM | 2026-06-13 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-11 16:52`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-9nzaC3pJX1NDDPnQDt9zMDKNPgKd2nq0Ecdtvs1G9ElAclF1` | kimi-k2.5 | 🆕 新規 | $12 | 10 RPM | 2026-06-12 | Kimi long-context general model |
