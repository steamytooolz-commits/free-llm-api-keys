...
### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-26 23:07`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-X2SnD0j17fCHTaaLKetkaE5gTrBTLRFPFZwziwt0QEK5UeWM` | smart-chat | 🆕 新規 | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |
| `sk-Rmo1gzyhiiY3kUqSR789Q0Hp7XXnS8SQCC3kYzObVI0gUmDY` | smart-chat | 🆕 新規 | $20 | 10 RPM | 2026-06-28 | Auto-routes across currently healthy low-cost chat backends |

### Kimi `06-26 23:07`

| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-fsuyOuCeSn7cgYAvtMcEftHvwJ02Z95q24Gs1LBxw991ZhdK` | kimi-k2.5 | 🆕 新規 | $10 | 10 RPM | 2026-06-28 | Kimi long-context general model |
