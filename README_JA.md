...
### マルチモデル (GPT-5.5 / Claude / DeepSeek / Gemini 自動ルーティング) `06-19 02:37`
...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-iBUWHq6Y3lTqjYeRWI3wD2BBCQjZbGhS1UwiFvC5ok9QyAOm` | kimi-k2.5 | 🆕 新規 | $10 | 10 RPM | 2026-06-20 | Kimi long-context general model |
