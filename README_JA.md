...
[![Keys](https://img.shields.io/badge/利用可能なKey-10-brightgreen?style=for-the-badge)]()
...
| Key | モデル | ステータス | 予算 | レート | 有効期限 | 説明 |
|-----|--------|------------|------|--------|----------|------|
| `sk-dpcyKZuec41434HjKsMQOKD5DfEVOr4zNVD9lz2ZYSXCXuZO` | deepseek-chat | 🆕 新規 | $18 | 20 RPM | 2026-05-27 | Everyday chat, coding, translation, writing |
| `sk-9xYZlbegbolk6hI3LHsfboKAZJgkzmNxZABSZjqyoe6k1TnE` | deepseek-chat | 🆕 新規 | $14 | 20 RPM | 2026-05-26 | Everyday chat, coding, translation, writing |
